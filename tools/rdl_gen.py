...
def main() -> None:
    ...
    # synthesis/sim input, so they're not listed here.) The header is
    # tagged as an include file so FuseSoC's source-resolution picks up
    # its containing directory for -I purposes.
    core = {
        "name": vlnv,
        "filesets": {
            "rdl_generated": {
